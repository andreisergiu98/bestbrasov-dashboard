...
function watchMain(tsconfigPath = 'tsconfig.json') {
	const configPath = typescript_1.default.findConfigFile(
		/*searchPath*/ './',
		typescript_1.default.sys.fileExists,
		tsconfigPath
	);
	if (!configPath) {
	...
	// a set of root files.
	const host = typescript_1.default.createWatchCompilerHost(
		configPath,
		{},
		typescript_1.default.sys,
		createProgram,
		createReportDiagnostic(typescript_1.default.sys),
...
function createReportDiagnostic(system) {
	...
	return (diagnostic) => {
		...
		console.log(
			namespace,
			typescript_1.default.formatDiagnosticsWithColorAndContext(diagnostics, host)
		);
